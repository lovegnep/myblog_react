...
(function(Editor, markdownit, WebUploader){
    ...
    var ToolImage = function(){
        var self = this;
        this.$win = $([
            '<div class="modal hide fade" style="font-size:20px" tabindex="-1" role="dialog" aria-labelledby="editorToolImageTitle" aria-hidden="true">',
                '<div class="modal-header">',
                    '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>',
                ...
                '<div class="modal-body">',
                    '<div class="upload-img">',
                        '<div class="button" style="font-size:17px;line-height:21px">上传图片</div>',
                        '<span class="tip"></span>',
